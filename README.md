...
This is a simple skeleton TypeScript Express server project that works on any of the [balena][balena-link] supported devices.

This project serves up a simple "Welcome to Balena" HTML on port `:80` of your balena device.
